...
class Officer {
    public:
        ...
        Home register_vehicle(string make, string model, string registration_number, time_t registration_expiry_date, Home home) {
            Vehicle vehicle(make, model, registration_number, registration_expiry_date);
            home.vehicles.push_back(vehicle);
            cout << home.vehicles.size() << endl;
            cout << "Vehicle registered successfully." << endl;
            Home returnHome = home;
...
int main() {
    ...
    home.vehicles = me.register_vehicle(a,a,b, time(NULL), home).vehicles;
    cout << me.vehicles.size() << endl;
    //me.register_vehicle(a,a,b, time(NULL), home);
    home.vehicles = me.register_vehicle(a,a,b, time(NULL), home).vehicles;
    cout << me.vehicles.size() << endl;
